...
|:----------------:|:----------------------------------------:|
|       0.8.*      | keptnsandbox/jira-service:0.8 |
...
Docker Images are automatically pushed based on the configuration done in [.ci_env](.ci_env) and the two [GitHub Secrets](https://github.com/keptn-sandbox/jira-service/settings/secrets/actions)
